...
const expresiones = {
    ...
    segundoapellido: /^[a-zA-ZÀ-ÿ\s]{1,40}$/ // Letras y espacios, pueden llevar acentos.
}
const campos = {
	usuario: false,
	nombre: false,
...
formulario.addEventListener('submit', (e) => {
	...
	if(campos.usuario && campos.nombre && campos.password && campos.correo && campos.telefono && campos.primerapellido && campos.segundoapellido &&campos.dni && terminos.checked ){
		formulario.reset();
